...
<form method="POST" name="frm">
	...
	<table border="1">
		<tr>
			<th>회원번호(자동발생)</th>
			<td><input readonly name="custno" value="<%=rs.getString(1)%>"></td>
		</tr>
		<tr>
			<th>회원성명(자동발생)</th>
		...
		<tr>
			<th>가입일자</th>
			<td><input name="joindate" readonly value="<%=rs.getString(2)%>"></td>
		</tr>
		<tr>
...
<%
	...
	Connection conn = DBConn.getConnection();
	PreparedStatement pstmt = conn.prepareStatement(
			"INSERT INTO MEMBER_TBL_02 VALUES (?, ?, ?, ?, TO_DATE(?, 'YYYYMMDD'), ?, ?)");
	int idx=1;
